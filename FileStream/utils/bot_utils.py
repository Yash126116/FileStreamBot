    ...
    if "video" in mime_type:
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("sʜᴀʀᴇ ᴠɪᴅᴇᴏ", url=f"https://telegram.me/share/url?url={file_link}"), InlineKeyboardButton("ʀᴇᴠᴏᴋᴇ ғɪʟᴇ", callback_data=f"msgdelpvt_{_id}")],
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("sʜᴀʀᴇ ғɪʟᴇ", url=f"https://telegram.me/share/url?url={file_link}"), InlineKeyboardButton("ʀᴇᴠᴏᴋᴇ ғɪʟᴇ", callback_data=f"msgdelpvt_{_id}")],
                [InlineKeyboardButton("ᴄʟᴏsᴇ", callback_data="close")]
            ]
        )
